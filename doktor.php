		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Istorija poseta</h5>
			...
			<form method="post" action="dnevnalistaR.php">
				<table class="table" id="table_field">
					...
					while ($row=mysqli_fetch_assoc($result)) { ?>
						<?php $id=$row['id_p']; ?>
						<?php $_SESSION['idPacijentaa']=$row['id_p']; ?>
						...
						<tr>
							...
							<td><a href="novaPosetaSS.php?poseta=<?php echo $row['id_p'];?>" class="btn btn-info">Sablon 1</a></td>
							<td><a href="sablon2.php?sablon=<?php echo $row['id_p'];?>" class="btn btn-info">Sablon 2</a></td>
							<td><a href="pregledPosetaP.php?pregled=<?php echo $row['id_p'];?>" class="btn btn-secondary view_btn">Pregled poseta</a></td>
						</tr>
					<?php } ?>				
				</table>
