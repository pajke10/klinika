...
<body>
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">	
			<h3 style="color:white;">Dnevni izvestaj odradjenih pregleda</h3>
		</div>
	</nav>
	<div class="container">	
		<h3 style="text-align:center; font-weight:bold;">Dnevni izvestaj odradjenih pregleda</h3>
		<div class="row">
			<form class="form-horizontal" action="marina_print.php" method="POST">
